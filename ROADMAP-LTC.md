...
| #   | Amélioration                                                                                              | Réf upstream | Effort  | Statut                                                                                                                                                         |
| --- | --------------------------------------------------------------------------------------------------------- | ------------ | ------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 3   | **TTS pluggable** — interface provider + ElevenLabs, OpenAI TTS, Piper (voix locales). Voix FR/africaines | #337         | Moyen   | ✅ `hyperframes tts --provider heygen\|elevenlabs\|openai\|fishspeech\|piper\|kokoro` — fishspeech = clonage de voix local (Fish Speech/OpenAudio, licence NC) |
